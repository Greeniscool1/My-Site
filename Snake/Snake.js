...
function addSnake() {
    ...
    //console.log({grid: grid[item.row+rowAdd][item.column+columnAdd], row: item.row+rowAdd, column: item.column+columnAdd, direction:item.direction});
    console.log({row: item.row+rowAdd, column: item.column+columnAdd, direction:item.direction});
